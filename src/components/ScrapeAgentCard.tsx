...
import { z } from "zod";
import { Globe, Link as LinkIcon, Loader2, Search, FileText } from "lucide-react";
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <div className="flex gap-2 mt-1">
                  <FormControl>
                    <Input id="url" placeholder="https://example.com" {...field} />
                  </FormControl>
              ...
              <div className="space-y-4 h-full flex flex-col">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{scrapeData.textSummary}</p>
                  </div>
                </div>
                ...
                <div className="flex-grow flex flex-col min-h-0">
                   <div className="flex items-center gap-3 mb-2">
                    ...
                    <h5 className="font-semibold">
                      Found Links <Badge variant="secondary">{scrapeData.links.length}</Badge>
                    </h5>
                  </div>
